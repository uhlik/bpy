...
bl_info = {"name": "Color Management Presets",
           "description": "Presets support for Scene > Color Management panel",
           "author": "Jakub Uhlik",
           "version": (0, 0, 1),
           "blender": (2, 79, 0),
           "location": "Properties > Scene > Color Management",
           "warning": "",
           "wiki_url": "",
           "tracker_url": "",
           "category": "System", }
...
def CMP_UI_draw(self, context, ):
    ...
    r.operator('color_management_presets.add', text="", icon='ZOOMIN', )
    r.operator('color_management_presets.add', text="", icon='ZOOMOUT', ).remove_active = True
    l.separator()
...
def default_presets():
    d = {'filmic_high_contrast': ('sRGB', 'Filmic', 0.0, 1.0, 'Filmic - High Contrast', False, 'sRGB', ),
         ...
         'default': ('sRGB', 'Default', 0.0, 1.0, 'None', False, 'sRGB', ), }
    return d
...
def register():
    ...
    bpy.types.SCENE_PT_color_management.prepend(CMP_UI_draw)
    setup()


def unregister():
    bpy.types.SCENE_PT_color_management.remove(CMP_UI_draw)
